...
#define LPSPI_IP_BOARD_INITPERIPHERALS_AR_RELEASE_MINOR_VERSION_PBCFG_C         7
#define LPSPI_IP_BOARD_INITPERIPHERALS_AR_RELEASE_REVISION_VERSION_PBCFG_C      0
#define LPSPI_IP_BOARD_INITPERIPHERALS_SW_MAJOR_VERSION_PBCFG_C                 3
...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if Lpspi_Ip.h and Lpspi_Ip_BOARD_InitPeripherals_PBcfg.c are of the same vendor */
#if (LPSPI_IP_VENDOR_ID != LPSPI_IP_BOARD_INITPERIPHERALS_VENDOR_ID_PBCFG_C)
    #error "Lpspi_Ip.h and Lpspi_Ip_BOARD_InitPeripherals_PBcfg.c have different vendor ids"
#endif
/* Check if Lpspi_Ip.h file and Lpspi_Ip_BOARD_InitPeripherals_PBcfg.c file are of the same Autosar version */
...
#error "AutoSar Version Numbers of Lpspi_Ip.h and Lpspi_Ip_BOARD_InitPeripherals_PBcfg.c are different"
#endif
...
#error "Software Version Numbers of Lpspi_Ip.h and Lpspi_Ip_BOARD_InitPeripherals_PBcfg.c are different"
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if (LPSPI_IP_DMA_USED == STD_ON)
        /* Check if current file and Dma_Ip header file are of the same Autosar version */
        #if ((DMA_IP_AR_RELEASE_MAJOR_VERSION != LPSPI_IP_BOARD_INITPERIPHERALS_AR_RELEASE_MAJOR_VERSION_PBCFG_C) || \
             (DMA_IP_AR_RELEASE_MINOR_VERSION != LPSPI_IP_BOARD_INITPERIPHERALS_AR_RELEASE_MINOR_VERSION_PBCFG_C))
        #error "AutoSar Version Numbers of Lpspi_Ip_BOARD_InitPeripherals_PBcfg.c and Dma_Ip.h are different"
        #endif
    #endif
#endif
/*==================================================================================================
...
{
    0U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(159U) | LPSPI_CCR_PCSSCK(159U) | LPSPI_CCR_SCKDIV(158U) | LPSPI_CCR_DBT(158U)), /* ccr */
